import { Controller, Post, Body, Get, HttpCode, Query, HttpException, HttpStatus, Put, Delete, UseGuards } from '@nestjs/common';
import { UserService } from './user.service';
import { User } from './user.entity';
import { validateUser, validateChangePasswordData, validateForgotPasswordData } from './users.validator';
import { IChangePassword, IForgotPassword } from '../interfaces.global';
import { validateUserPassword } from './user.utils';
import { CustomGuart } from 'src/login/login.guard';
